    ...
    return (
        <div className="flex w-full max-w-[500px] flex-col items-center justify-center gap-4 p-4 sm:w-[500px] sm:p-8">
            ...
            <p className="text-5xl">
                Code <span className="text-blue-600">Collab</span> App
            </p>
            ...
            <form onSubmit={joinRoom} className="flex w-full flex-col gap-4">
                <input
                    ...
                    name="roomId"
                    placeholder="Room Id"
                    className="w-full rounded-md border-2 border-gray-500 bg-darkHover px-3 py-3 hover:border-blue-600 focus:outline-none"
